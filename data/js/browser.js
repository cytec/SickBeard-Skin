(function () {
    ...
    $.fn.nFileBrowser = function (callback, options) {
        ...
        if (!fileBrowserDialog) {
            ...
            fileBrowserDialog = $('<div id="fileBrowserDialog" class="modal" style="display:hidden"><div class="modal-header"></div></div>').appendTo('body').dialog({
    ...
    $.fn.fileBrowser = function (options) {
        ...
        return options.field.addClass('fileBrowserField').after($('<input type="button" value="Browse&hellip;" class="fileBrowser btn" />').click(function () {
